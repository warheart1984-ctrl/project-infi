#!/usr/bin/env python3
"""Bootstrap Alt-18 gates, tests, active docs, and proof stubs."""
...
ORGANS = [('project_infi_state_machine_organ',
  'platform',
...
Status: **mvp** (Alt-18 summon wave `{BATCH}`)
...
| Gate passes under alt18-governed-gate | proven |

## Reproduction

```bash
make {gate}-organ-gate
make alt18-governed-gate
```
"""
...
def main() -> None:
    ...
    print(f"[alt18-runtime] wrote {len(ORGANS)} gate/test/doc bundles")
