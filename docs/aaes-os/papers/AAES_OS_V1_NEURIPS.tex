...
\begin{itemize}
    \item A unified constitutional architecture grounded in three mathematical layers.
    \item CAS 1.0, a formal object model for governed cognition.
    \item CRK-1, a deterministic constitutional runtime.
    \item CTS, a conformance test suite for invariant compliance.
    \item CDP-1, a reproducible continuity benchmark.
    \item CEP, an experimental platform enabling independent replication.
\end{itemize}
...
\section{Discussion}
We discuss limitations, future work, and implications for governed intelligence.

\section{Conclusion}
AAES-OS v1.0 establishes the first reproducible, constitutional framework for governed AI systems. It provides a scientific foundation for deterministic governance, continuity measurement, and independent replication.
