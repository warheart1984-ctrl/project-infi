...
The founding document of Continuity OS.
...
- [Book of Invariants](invariants/book-of-invariants.md) — formal invariant codex
- [Steward's Oath](stewardship/stewards-oath.md) — commitment read at certification
- [Developer Guide](developer-guide.md) — runtime integration for engineers
- [K-∞ Commentary](../crk1/continuity-os/K_INFINITY_CONSTITUTIONAL_COMMENTARY.md)
- [Unified Preamble](../crk1/continuity-os/CRK1_CONSTITUTIONAL_PREAMBLE.md)
