...
Wraps: [`src/governance_organs/linguistic_governance_attestation_engine.py`](../../src/governance_organs/linguistic_governance_attestation_engine.py).
...
Schema: [schemas/linguistic_governance_attestation_organ.v1.json](./schemas/linguistic_governance_attestation_organ.v1.json)
