...
Read-only world pack registry and manifest lane posture.

Wraps: [`external/story_forge/src/story_forge/worldpacks/`](../../external/story_forge/src/story_forge/worldpacks/).
...
Schema: [schemas/world_pack_lane_organ.v1.json](./schemas/world_pack_lane_organ.v1.json)
...
- `GET /api/jarvis/world-pack-lane/status` — read-only status
...
Target proof packet: `docs/proof/storyforge/WORLD_PACK_LANE_ORGAN_V1_PROOF.md`
...
**Release:** `alt28-summon-wave-2026-06` — order **6**

**Depends on:** `text_to_3d_world_lane_organ`, `story_forge_lane_organ`
