# Linguistic Remediation Subsystem
...
Read-only drift remediation playbook posture (Wave 9).

Wraps: [`src/governance_organs/linguistic_remediation_engine.py`](../../src/governance_organs/linguistic_remediation_engine.py).
...
Schema: [schemas/linguistic_remediation_organ.v1.json](./schemas/linguistic_remediation_organ.v1.json)
...
- `GET /api/jarvis/linguistic-remediation/status` — read-only status
- `src/linguistic_remediation_organ.py` — status builder
...
Target proof packet: `docs/proof/platform/LINGUISTIC_REMEDIATION_ORGAN_V1_PROOF.md`
...
| Structure | `src/linguistic_remediation_organ.py` |
...
**Release:** `alt22-summon-wave-2026-06` — order **7**

**Depends on:** `linguistic_drift_predictor_organ`

**Minimal invariants:**

- Read-only v1
- `module_id` frozen to `AAIS-LRM-01`
