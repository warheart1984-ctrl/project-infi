...
Read-only /pipeline movie front-door posture.
...
Schema: [schemas/text_game_to_video_organ.v1.json](./schemas/text_game_to_video_organ.v1.json)
...
- `GET /api/jarvis/text-game-to-video/status` — read-only status
...
Target proof packet: `docs/proof/storyforge/TEXT_GAME_TO_VIDEO_ORGAN_V1_PROOF.md`
...
**Release:** `alt28-summon-wave-2026-06` — order **3**

**Depends on:** `story_forge_lane_organ`, `story_forge_launcher_organ`, `movie_renderer_lane_organ`
