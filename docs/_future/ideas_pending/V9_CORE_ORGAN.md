...
Read-only V9 core lane posture; inspects POST /api/jarvis/v9-core.

Wraps: [`src/v9_core.py`](../../src/v9_core.py).
...
Schema: [schemas/v9_core_organ.v1.json](./schemas/v9_core_organ.v1.json)
...
- `GET /api/jarvis/v9-core/status` — read-only status
- `src/v9_core_organ.py` — status builder
...
Target proof packet: `docs/proof/platform/V9_CORE_ORGAN_V1_PROOF.md`
...
| Structure | `src/v9_core_organ.py` |
...
**Release:** `alt21-summon-wave-2026-06` — order **2**
...
- Read-only v1
- `module_id` frozen to `AAIS-V9C-01`
