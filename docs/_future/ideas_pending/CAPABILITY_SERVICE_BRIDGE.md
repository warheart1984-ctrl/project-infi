...
Read-only governed capability service-lane bridge posture.
...
- `GET /api/jarvis/capability-bridge/status` — read-only status
...
Target proof packet: `docs/proof/platform/CAPABILITY_SERVICE_BRIDGE_V1_PROOF.md`
...
**Release:** `alt27-summon-wave-2026-06` — order **3**

**Depends on:** `governance_layer_organ`, `operator_cognition_coherence_fabric`
