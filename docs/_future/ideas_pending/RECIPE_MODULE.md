...
Read-only recipe module workflow template posture.
...
Target proof packet: `docs/proof/platform/RECIPE_MODULE_V1_PROOF.md`
...
**Release:** `alt27-summon-wave-2026-06` — order **6**

**Depends on:** `capability_service_bridge`, `module_governance_organ`
