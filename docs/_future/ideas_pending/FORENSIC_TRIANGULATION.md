...
Read-only forensic triangulation correlate posture.
...
Schema: [schemas/forensic_triangulation.v1.json](./schemas/forensic_triangulation.v1.json)
...
Target proof packet: `docs/proof/forensics/FORENSIC_TRIANGULATION_V1_PROOF.md`
...
**Release:** `alt27-summon-wave-2026-06` — order **2**

**Depends on:** `cisiv_operator_lineage_console`, `scorpion_bridge_organ`
