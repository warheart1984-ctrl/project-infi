# Linguistic Governance Queue Organ
...
Wraps: [`src/governance_organs/linguistic_governance_queue_engine.py`](../../src/governance_organs/linguistic_governance_queue_engine.py).
...
Schema: [schemas/linguistic_governance_queue_organ.v1.json](./schemas/linguistic_governance_queue_organ.v1.json)
