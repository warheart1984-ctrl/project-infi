"""Result normalization for `generate_tests` contractor requests."""
...
guidance = (
    "Generate test files only. Return runnable test artifacts and avoid prose outside the "
    "JSON response."
)
