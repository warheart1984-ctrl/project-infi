"""Jarvis doctrine pack built around the three Angels and three Wards."""
...
class JarvisAngelsAndWards:
    def __init__(self) -> None:
        self.angels = [ShieldAngel(), ProtectAngel(), GuardAngel()]
        self.wards = [WardRail(), SeeRail(), WearyRail()]
