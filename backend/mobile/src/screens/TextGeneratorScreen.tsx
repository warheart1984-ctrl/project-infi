...
const TextGeneratorScreen = () => {
  ...
  const handleGenerate = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('http://your-api-url/api/text/generate', {
        prompt,
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sliderContainer}>
          <TextInput
            ...
            onChangeText={(val) => setMaxLength(parseInt(val) || 512)}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sliderContainer}>
          <TextInput
            ...
            onChangeText={(val) => setTemperature(parseFloat(val) || 0.7)}
