#!/usr/bin/env python3
"""Validate UGR cogos write-path artifacts."""
...
REQUIRED = [
    ...
    "docs/contracts/UGR_COGOS_WRITE_PATH_CONTRACT.md",
    "tests/test_ugr_cogos_pattern_bridge.py",
]
...
def main() -> int:
    ...
    print(f"ugr cogos write-path manifest validation: status={status}, findings={len(findings)}")
