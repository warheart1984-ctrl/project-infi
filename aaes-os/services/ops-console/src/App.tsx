...
import { NovaStudioCanvas, type SkillzMcgeeLedgerSummary } from './nova-studio/index.js';
...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTelemetry = async () => {
      ...
      const skillzmcgeeRes = await fetch('/skillzmcgee/ledger');
      const telemetry = (await telemetryRes.json()) as TelemetryResponse;
      const skillzmcgee = (await skillzmcgeeRes.json()) as SkillzMcgeeLedgerSummary;
...
export const OpsConsoleView: React.FC<LoadedState> = ({ telemetry, skillzmcgee, mriV2, enforcement, meta }) => (
  <div style={{ fontFamily: 'system-ui', padding: 16, color: '#172026', background: '#f6f7f9' }}>
    ...
    <nav style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
      <a href="#nova-studio">Nova Studio</a>
    ...
    <NovaStudioCanvas skillzmcgee={skillzmcgee} enforcement={enforcement} />
