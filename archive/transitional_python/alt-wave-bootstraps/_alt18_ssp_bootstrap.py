#!/usr/bin/env python3
"""One-shot bootstrap for Alt-18 SSP concept artifacts (schemas, specs, genomes)."""
...
BATCH = "alt18-summon-wave-2026-06"

ORGANS = [{'api': 'GET /api/jarvis/project-infi-state-machine/status',
...
Status: pending — Alt-18 summon wave `{BATCH}`.
...
`concept → prototype → mvp` via `tools/governance/alt18_promote_mvp.py`.
"""
...
def main() -> None:
    ...
    print(f"[alt18-ssp] wrote {len(ORGANS)} concept bundles")
